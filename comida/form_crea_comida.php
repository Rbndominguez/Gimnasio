...
<nav class="navbar navbar-light">
	...
	<section class="section">
		...
		<div class="form-group">
					...
					<input type="text" class="form-control" id="nombreComida" name="nombreComida" value="<?php echo $form_crea_comida["nombreComida"];?>" required/>
				</div>
				<div class="form-group">
					<label for="descripcion">Descripción: *</label>
					<input type="text" class="form-control" id="descripcion" name="descripcion" value="<?php echo $form_crea_comida["descripcion"];?>" required/>
				</div>
				</div> 
			</div>
