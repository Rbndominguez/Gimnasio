...
<head>
  ...
  function buscar(){
  	...
  	if (textoBusqueda != "") {
  		$.post("accion_buscar_asignar_tabla.php", {valorBusqueda: textoBusqueda}, function(mensaje) {
...
<main>
	...
	<form accept-charset="utf-8" method="POST">
		...
		<input type="text" name="busqueda" id="busqueda" size="50" value="" placeholder="" maxlength="50" autocomplete="off" onkeyup="buscar();" autofocus />
	</form>
	<br>
