...
<head>
  ...
  function buscar(){
  	...
  	if (textoBusqueda != "") {
  		$.post("accion_buscar_asignar_dieta.php", {valorBusqueda: textoBusqueda}, function(mensaje) {
...
<main>
	...
	<form accept-charset="utf-8" method="POST">
		...
		<input type="text" name="busqueda" id="busqueda" value="" placeholder="" size="50" maxlength="50" autocomplete="off" onkeyup="buscar();" autofocus />
	</form>
    <br>
