...
<small class="text-muted"><i>Los campos obligatorios están marcados con *</i></small>
        	...
        	<input type="text" class="form-control" id="dniMonitor" name="dniMonitor" type="text" placeholder="12345678X" pattern="^[0-9]{8}[A-Z]{1}$" title="8 digitos seguidos de una letra mayúscula" size="50" value="<?php echo $form_alta_monitor["dniMonitor"]; ?>"required>
            </div>

			<div class="form-group">
            <label for="nombre">Nombre: *</label>
        	<input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $form_alta_monitor['nombre'];?>" required/>
            </div>

			<div class="form-group">
            <label for="apellidos">Apellidos: *</label>
        	<input type="text" class="form-control" id="apellidos" name="apellidos" value="<?php echo $form_alta_monitor['apellidos'];?>" required/>
            </div>

			<div class="form-group">
            <label for="telefono">Teléfono: </label>
        	<input type="text" class="form-control" id="telefono" name="telefono" value="<?php echo $form_alta_monitor['telefono'];?>"/>
            </div>		

			<div class="form-group">
            <label for="fechaContratacion">Fecha de contratación: *</label>
        	<input type="date" class="form-control" id="fechaContratacion" name="fechaContratacion" value="<?php echo $form_alta_monitor['fechaContratacion'];?>" required/>
            </div>	
