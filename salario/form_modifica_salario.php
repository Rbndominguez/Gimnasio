...
<small class="text-muted"><i>Los campos obligatorios están marcados con *</i></small>
        	...
        	<input type="text" class="form-control" id="cantidad" name="cantidad" value="<?php echo $form_modifica_salario['cantidad'];?>" required/>
            </div>
			
			<div class="form-group">
            <label for="fecha">Fecha del salario: *</label>
        	<input type="date" class="form-control" id="fecha" name="fecha" value="<?php echo $form_modifica_salario['fecha'];?>" required/>
            </div>
